        ...
        <main id="home_page">
            ...
            <section id="section_about">
                <div className="about_content">
                    ...
                    <p>Для корпоративных клиентов мы предоставляем услуги по аренде транспорта для групповых мероприятий
                        и деловых поездок. Наша система позволяет легко заказывать автомобили разных типов и в любом
                        количестве, а также оформлять регулярные заказы по заданному графику.</p>
